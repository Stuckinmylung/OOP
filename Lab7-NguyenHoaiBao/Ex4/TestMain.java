...
public class TestMain {
    public static void main(String[] args) {
        ...
        MovableCircle mvc1 = new MovableCircle(7,8,1,1,4);
        System.out.println("Begin Circle : " + mvc1);
        mvc1.moveDown();
        System.out.println("MVCPoint after move Down : " + mvc1);
